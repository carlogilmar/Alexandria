...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::diagrams::diagram_by_id,
            commands::diagrams::create_diagram,
            commands::diagrams::rename_diagram,
            commands::diagrams::update_diagram_source,
            commands::diagrams::delete_diagram,
            commands::diagrams::set_diagram_pinned,
            commands::diagrams::set_diagram_archived,
